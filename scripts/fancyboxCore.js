!(function (t, e) {
    ...
    class k extends g {
        ...
        updateMetrics(t = !1) {
            ...
            s &&
                ...
                (f.style.cssText = m),
                s && ((f.style.width = `${v}px`), (f.style.height = `${y}px`)),
                this.setTransform(),
    ...
    const lt = (t, e = {}) => {
        ...
        ct = {
            ...
            videoAutoplay: !0,
            videoRatio: 16 / 9,
            videoTpl: '<video class="fancybox__html5video" playsinline controls loop controlsList="" poster="">\n  <source src="{{src}}" type="{{format}}" />Sorry, your browser doesn\'t support embedded videos.</video>',
            videoFormat: "",
    ...
    Object.defineProperty(jt, "version", { enumerable: !0, configurable: !0, writable: !0, value: "5.0.16" }),
